...
export const LISTINGS: Listing[] = [
  ...
  },
  {
    ...
    city: 'Fort Worth',
    state: 'TX',
    description: 'Custom landscape lighting design serving a wide range of DFW communities.',
    services: ['Landscape Lighting', 'Home Exterior Lighting', 'Poolside Lighting', 'Tree Lighting', 'Pergola Lighting', 'Specialty Lighting', 'Maintenance'],
